               ...
               if((calc_status.error_flag) && Key != 'C')
                       ...
                       switch(Key)
                       {
                              ...
                              case '*':
															 ...
															 if(calc_status.operand_2_flag && calc_status.operator_flag)
															 {
                                                                        Lcd_Out(2,1, "ERR: operands > 2");
                                                                        Lcd_Cmd(_LCD_CURSOR_OFF);
                                                                        calc_status.error_flag = 1; 
                                                                        break;
                                                             } 
